...
<html lang="en">
<head>
<title>Consultancy Profile Widget Flat Responsive Widget</title>
...
<body>
	<div class="main">
							...
							<div class="abt-agile-right">
								...
								<ul class="address">
									...
									<li>
										<ul class="address-text">
											<li><b>E-MAIL </b></li>
											<li><a href="mailto:roddy.blk@mail.com">: mail@example.com</a></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
		...
		<div class="agileits_copyright">
			<p>© 2024 Consultancy Profile Widget. All rights reserved</p>
		</div>
	</div>
